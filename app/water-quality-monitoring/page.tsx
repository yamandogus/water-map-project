...
const waterSources: WaterSource[] = [
  ...
  // Konya
  {
    ...
    name: "Beyşehir Gölü",
    type: "lake",
    coordinates: { lat: 37.7833, lng: 31.5 },
  },
  // Van
  {
    id: "van",
  ...
  // Tuz Gölü
  {
    ...
    name: "Tuz Gölü",
    type: "lake",
    coordinates: { lat: 38.75, lng: 33.4167 },
  },
  // Seyhan
  {
    id: "seyhan",
      ...
      try {
        const data = await Promise.all(
          waterSources.map(async (source) => {
            ...
            const evaluation = qualityData
              ? WaterQualityService.evaluateWaterQuality(qualityData)
              : null;
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Gösterilen su kalitesi değerleri simülasyon amaçlı üretilmiştir. Karbon ayak izi
                hesaplamaları Carbon Interface API kullanılarak yapılmaktadır. Su kalitesi
                değerlendirmeleri WHO (Dünya Sağlık Örgütü) ve TSE standartlarına göre
                yapılmaktadır. İçilebilirlik durumu, tüm parametrelerin WHO standartlarına
